...
trip_distance <- function(data){
  data_sf <- data %>%
    mutate(start_station_sf = st_as_sf(trip_history_sample, coords = c("start_station_longitude", "start_station_latitude"),
                                       crs = 4326, agr = "constant"),
           end_station_sf = st_as_sf(trip_history_sample, coords = c("end_station_longitude", "end_station_latitude"),
                                     crs = 4326, agr = "constant")) %>%
